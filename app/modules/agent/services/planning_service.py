"""
PlanningService — generates execution plans for multi-agent orchestration.

Responsibility: Determine which agents should run and in what order based on
the user's question, conversation history, and available tools.
"""
...
from app.modules.agent.protocols import IActionAgent
...
class PlanningService:
    ...
    def _enforce_rag_core(
        ...
        # Ensure reasoning_agent exists after retrieval
