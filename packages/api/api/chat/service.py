"""Chat service — orchestrates session, memory, and agent pipeline."""
...
from shared.protocols import IMemoryService
from shared.schemas import MemoryEntry, ResponseMetadata
...
class ChatService:
    ...
    Delegates all LLM invocation, retrieval, reasoning, and tool execution to OrchestratorAgent.
    """

    def __init__(
        self,
        orchestrator_service: OrchestratorAgent,
