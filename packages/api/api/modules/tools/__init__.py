...
from api.modules.tools.implementations import (
    CalculatorTool,
    DateTimeNowTool,
    DocumentLookupTool,
    ScientificCalcTool,
...
from api.modules.tools.registry import ToolRegistry
...
def get_tool_registry(
    ...
    if settings.enable_demo_tools:
        try:
            from api.modules.tools.implementations.showcase import (
                MockAPITool,
                MockDatabaseTool,
                MockWeatherTool,
            )
