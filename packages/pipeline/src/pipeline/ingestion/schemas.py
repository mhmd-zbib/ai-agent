...
Backward compatibility shim — all types now live in ``core.models.document``.
...
# Backward compat — these types now live in core.models.document
...
__all__ = [
    # re-exported from common.models.document
    "ELEMENT_TYPES",
    "ATOMIC_ELEMENT_TYPES",
    "HEADING_ELEMENT_TYPES",
    "DocumentElement",
