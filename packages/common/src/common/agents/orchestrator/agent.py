...
from ..core.context import AgentContext, AgentResult
...
from .schemas import MemoryOutput  # noqa: E402
...
class ExecutionCoordinator:
    ...
    def _execute_step(
        ...
        from common.agents.orchestrator.schemas import AgentStep as _AgentStep  # local import
    ...
    def _execute_retrieval(
        ...
        from common.agents.orchestrator.schemas import AgentStep
