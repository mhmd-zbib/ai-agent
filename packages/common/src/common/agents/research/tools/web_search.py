"""
agents.research.tools.web_search — WebSearchTool using the DuckDuckGo instant-answer API.

Migrated from packages/api/src/api/modules/tools/implementations/web_search.py.
Import path changes:
...
from ...core.tool import BaseTool, ToolExecutionError, ToolValidationError
